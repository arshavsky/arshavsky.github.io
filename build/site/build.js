...
Beast.decl({
    BookPage: {
        requestApiV2: function (path, data) {
            ...
            var jsonUrl = 
            'https://5jnrq8s6.apicdn.sanity.io/v1/data/query/production?query=*[slug.current%20==%27' 
            + lastParamValue + 
            '%27]{%20title,%20slug,%20author,%20"cover":%20cover.asset->url,%20"highlightsText":%20thoughts[]%20{%20"text":%20children[].text}}';
